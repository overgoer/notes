...
| 🛠️ Действие     | 📚 Название | ✏️ Описание                        |
|------------------|-------------|------------------------------------|
| ➕ Создать       | Create      | Добавить новый объект/запись       |
| 👁️ Читать       | Read        | Получить или просмотреть данные    |
| ♻️ Обновить      | Update      | Изменить существующие данные       |
| ❌ Удалить       | Delete      | Удалить объект или запись          |
